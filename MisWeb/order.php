            ...
            if (isset($_POST['submit']))
             {
                // get all the details from the form 
                 ...
                 $price=$_POST['price'];
                 $qty=$_POST['qty'];
                 $total=$price * $qty; //basic multiplication to calculate total 
                 $order_date= date("Y-m-d h:i:sa"); //order date
                 $status="Ordered";  //ordered, on delivery,delivered,cancelled -> maintained by admin in admin panel
                 ...
                 // check whetherquery executed successfully or not  
